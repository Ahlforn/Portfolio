{
    ...
    xeogl.AxisHelper = function (cfg) {
        ...
        var meshes = [
            ...
            //    geometry: new xeogl.VectorTextGeometry(scene, {text: "1", size: 1.5}), // X
            ...
            new xeogl.Mesh(scene, {  // Label
                geometry: new xeogl.VectorTextGeometry(scene, {text: "P", size: 1.5}), // Y
            ...
            //new xeogl.Mesh(scene, {  // Label
            //    geometry: new xeogl.VectorTextGeometry(scene, {text: "3", size: 1.5}), // Z
