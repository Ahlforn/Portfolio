...
var InitStoredValues = function () {
    ...
    var industryContainer = $("#industries");
    ...
    if (industryContainer.data("id") != null) {
        var industryID = Number(industryContainer.data("id"));
        for (var _h = 0, industries_1 = industries; _h < industries_1.length; _h++) {
            var industry = industries_1[_h];
...
var GenerateIndustryOption = function (industry) {
    var option = document.createElement("option");
...
var GenerateIndustries = function () {
    var input = document.getElementById("industries");
    var placeholder = null;
    if (selectedIndustry == null) {
        placeholder = GenerateEmptyOption();
        input.appendChild(placeholder);
    }
    for (var _i = 0, industries_2 = industries; _i < industries_2.length; _i++) {
        var industry = industries_2[_i];
...
var UpdatePrice = function () {
    ...
    var aabb = document.querySelector("input[name = aabb]");
    var materials = document.querySelector("select#materials");
    var layerThicknesses = document.querySelector("select#layerThicknesses");
    var printers = document.querySelector("select#printers");
    if (aabb.value.length == 0 ||
...
var getModelSnapshot = function () {
    var source = document.getElementById("stl_canvas");
    var axisHelper = document.querySelector('canvas[id^="xeogl-axisHelper-canvas"]');
