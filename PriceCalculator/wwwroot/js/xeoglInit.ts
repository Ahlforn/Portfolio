...
/// <reference path="typings/xeogl/xeogl.d.ts" />

import * as xeogl from "../lib/xeogl/xeogl.js";

type PriceUpdateFunction = () => void;

class InitXeogl {
    printDirection: JQuery;
    aabb: JQuery;
    scene: xeogl.Scene;
    model: xeogl.Component;
    plane: xeogl.Component;
    _PrintDirection: Float32Array;
    _AABB: [Number, Number, Number, Number, Number, Number];

    constructor(updatePriceFunction: PriceUpdateFunction) {
    ...
    set PrintDirection(eulerAngles: Float32Array) {
    ...
    get PrintDirection(): Float32Array {
